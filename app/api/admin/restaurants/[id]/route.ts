...
export async function GET(request: NextRequest, context: Context) {
    try {
        ...
        // Find the restaurant – cast id to any
        const restaurant = await Restaurant.findById(id as any).lean();
        ...
        // Get associated food items – cast id to any
        const foodItems = await FoodItem.find({ restaurant: id as any })
            .select('name price category isAvailable images rating')
            .sort({ createdAt: -1 })
            .lean();
        ...
        return NextResponse.json({
            ...
            data: {
                ...
                foodItems,
                stats: {
                    totalFoodItems: await FoodItem.countDocuments({ restaurant: id as any }),
                    availableFoodItems: await FoodItem.countDocuments({
...
export async function PATCH(request: NextRequest, context: Context) {
    try {
        ...
        // Find and update restaurant – cast id to any
        const restaurant = await Restaurant.findByIdAndUpdate(
            id as any,
            {
                ...body,
...
export async function DELETE(request: NextRequest, context: Context) {
    try {
        ...
        // Find restaurant first – cast id to any
        const restaurant = await Restaurant.findById(id as any);
        if (!restaurant) {
            return NextResponse.json({
                success: false,
                message: 'Restaurant not found'
        ...
        // Delete associated food items – cast id to any
        await FoodItem.deleteMany({ restaurant: id as any });

        // Delete restaurant – cast id to any
        await Restaurant.findByIdAndDelete(id as any);
