...
import Restaurant from '@/models/Restaurant'; // <-- import Restaurant
...
export async function GET(request: NextRequest, context: Context) {
    try {
        ...
        // Build query – cast id to any
        let query: any = { restaurant: id as any };
        ...
        // Get food item stats – cast id to any
        const stats = {
            total: await FoodItem.countDocuments({ restaurant: id as any }),
            available: await FoodItem.countDocuments({ restaurant: id as any, isAvailable: true }),
            byCategory: await FoodItem.aggregate([
                { $match: { restaurant: id as any } },
