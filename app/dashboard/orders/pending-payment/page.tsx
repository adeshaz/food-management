...
// app/dashboard/orders/pending-payment/page.tsx
'use client';
                ...
                <Card className="border-2 border-blue-200">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {isAdmin && (
                                <Button onClick={handleAdminConfirmPayment} className="w-full bg-green-600 hover:bg-green-700">
                                    <UserCheck className="h-4 w-4 mr-2" />
                                    Confirm Payment Received (Admin)
                                </Button>
                            )}

                            <Button onClick={() => router.push('/dashboard/orders')} className="w-full bg-blue-600 hover:bg-blue-700">
                                View My Orders
                            </Button>

                            <Button variant="ghost" onClick={() => router.push('/foods')} className="w-full">
                                Continue Shopping
                            </Button>
                        </div>
...
export default function PendingPaymentPage() {
    return (
        <Suspense fallback={<div className="flex justify-center items-center min-h-screen"><div className="h-8 w-8 animate-spin rounded-full border-4 border-blue-600 border-t-transparent"></div></div>}>
