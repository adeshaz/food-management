...
// app/(public)/foods/page.tsx - FIXED with Suspense
'use client';
...
function FoodsContent() {
    ...
    // The original JSX content (exactly as in your file) goes here.
    // I'll omit it for brevity in this answer, but you should copy the entire return JSX from the original file
    // and place it inside this function. The structure remains unchanged.
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Header Section */}
            <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-8">
...
export default function FoodsPage() {
    return (
        <Suspense fallback={<div className="flex justify-center items-center min-h-screen"><Loader2 className="h-12 w-12 animate-spin text-green-600" /></div>}>
            <FoodsContent />
        </Suspense>
    );
}