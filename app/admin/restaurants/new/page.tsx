            ...
            <div className="max-w-4xl mx-auto">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Add a new restaurant to your platform. All fields are required unless marked optional.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                    ...
                                    {images.map((image, index) => (
                                        <div key={index} className="flex gap-2">
                                            <Input
                                                ...
                                                placeholder="Image URL (e.g., /images/restaurants/example.jpg or https://example.com/image.jpg)"
                                            />
                                            {images.length > 1 && (
                                                <Button
                                                    type="button"
